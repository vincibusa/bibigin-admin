          ...
          <CardContent>
            <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              <Link href="/products" className="block">
                <div className="p-3 sm:p-4 rounded-lg bg-accent/10 border border-accent/20 hover:bg-accent/20 transition-colors cursor-pointer">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-accent-foreground text-sm sm:text-base">
                      Aggiungi Prodotto
                    </h3>
                  ...
                  <Button size="sm" className="mt-2 sm:mt-3 w-full bg-navy hover:bg-navy/90 text-cream h-8 sm:h-9">
                    <span className="text-xs sm:text-sm">Vai ai Prodotti</span>
              ...
              <Link href="/orders" className="block">
                <div className="p-3 sm:p-4 rounded-lg bg-accent/10 border border-accent/20 hover:bg-accent/20 transition-colors cursor-pointer">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <ShoppingCart className="w-4 h-4 sm:w-5 sm:h-5 text-accent" />
                  </div>
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Visualizza e gestisci gli ordini in corso
                  </p>
                  <Button size="sm" className="mt-2 sm:mt-3 w-full bg-navy hover:bg-navy/90 text-cream h-8 sm:h-9">
                    <span className="text-xs sm:text-sm">Vai agli Ordini</span>
                    <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 ml-1 sm:ml-2" />
                  </Button>
                </div>
              </Link>
              ...
              <Link href="/analytics" className="block">
                <div className="p-3 sm:p-4 rounded-lg bg-accent/10 border border-accent/20 hover:bg-accent/20 transition-colors cursor-pointer">
                  ...
                  <Button size="sm" className="mt-2 sm:mt-3 w-full bg-navy hover:bg-navy/90 text-cream h-8 sm:h-9">
                    <span className="text-xs sm:text-sm">Vai alle Analytics</span>
                    <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 ml-1 sm:ml-2" />
                  </Button>
                </div>
              </Link>
          ...
          <CardContent>
            {loading ? (
                ...
                {recentOrders.map((order: Order) => (
                  <div key={order.id} className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      <div className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-navy/10 text-navy font-semibold text-xs">
                        #{order.id.slice(-4)}
                      </div>
              ...
              <div className="text-center py-8">
                ...
                <Link href="/orders">
                  <Button className="mt-2 bg-navy hover:bg-navy/90 text-cream h-9 sm:h-10">
                    <Plus className="w-4 h-4 mr-2" />
                    <span className="text-sm">Crea Primo Ordine</span>
                  </Button>
                </Link>
              </div>
            )}
